...
## Major changes made
1. Did data cleaning and Etl process, converted USD into INR
...
4. 4. In 4 years Bengaluru generating the lowest profit margin of -20.8%.if we can check the Profit Contribution % by Market then here also Bengaluru is the Lower with -0.3% of total contribution in total profit.
